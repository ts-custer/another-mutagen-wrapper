...
_frame_class_to_key_mapping = {  # 'APIC': AudioTagPicture is loaded, too, but in another way
...
frame_id_to_key_mapping: Dict[str, AudioTagKey] = {k.__name__: v for k, v in _frame_class_to_key_mapping.items()}
